    ...
    <div className="max-w-2xl mx-auto px-4 py-16 text-center space-y-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground text-sm max-w-md mx-auto leading-relaxed">
          Your booking enquiry has been logged successfully in our system. Our administration team is reviewing your
          details and preparing your official quotation.
        </p>
      </div>
      ...
      <Card className="border-border">
        <CardContent className="p-6 space-y-4">
          ...
          <p className="text-xs text-muted-foreground pt-2 border-t border-border">
            Please keep this reference for your records. We will send updates and your official quotation link directly
